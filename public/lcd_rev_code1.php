...
<body>
    ...
    <div id="container-main-pdf">
        ...
        <div class="pdf-container">
            <div class="sub-pdf-container">
                ...
                <iframe src="../src/controller/fetch_pdf.php" width="100%" height="1000px"></iframe>
    ...
    <div id="video-container">
        ...
        <div style="display:flex; justify-content:center; align-items:center; height:700px; margin-top:70px;">
            <video id="myVideo" controls>
                <source src="./assets/video/setup_vid.mp4" type="video/mp4">
    ...
    <div id="monitoring_data">
        ...
        <div class="header">
            <div class="logo">
                <img src="./assets/images/nichivi_logo.jpg" alt="Company Logo">
        ...
        <!-- Dropdown 3 -->
		                 ...
		                 <div class=" person1" id="operator1" style="display:none;">
                                ...
                                <div class="product-info">
                                    <div class="picture-product">
                                        ...
                                        <img height="275" width="190" src="./assets/images/prod-pic.jpg" alt="picture product">
                ...
                <script src="./assets/js/dowtime_data.js"></script>
                <script src="./assets/js/drop_downtime_form.js"></script>
                <script src="./assets/js/ngsend.js"></script>
                <script src="./assets/js/history.js"></script>
                <script src="./assets/js/plan_data_output.js"></script>
                <script src="operator_image.js"></script>
                <script src="./assets/js/save_data.js"></script>
                <script src="./assets/js/personnel.js"></script>
                <script src="./assets/js/line_leader.js"></script>
                ...
                <script>
                    ...
                    function send_plan() {
                        ...
                        xhr.open("POST", "../src/controller/check_plan.php", true);
                ...
                <script>
                    ...
                    function submitPIN() {
                        ...
                        if (pin === correctPin) {
                            ...
                            fetch('../src/controller/getHourlyData.php')
                                .then(res => {
                    ...
                    function sendEditData() {
                        ...
                        Promise.all([
                                fetch('../src/controller/updateHourlyData.php', {
                                    method: 'POST',
                                    headers: {
                                ...
                                fetch('../src/controller/edit_controller.php', {
                                    method: 'POST',
                                    headers: {
                                        'Content-Type': 'application/json'
                                    },
