...
function submitng() {
  ...
  xhr.open("POST", "../scr/controller/sendNgdetails.php", true);
  ...
  xhr1.open("POST", "../src/controller/signal.php", true);
  ...
  xhr2.open("POST", "../src/controller/timeVal.php", true);
  ...
  xhr3.open("POST", "../src/controller/server_inputNg.php", true);
